...
<td>修改</td>
          ...
          <td><input type="checkbox" name="ids" value="${s.id}" /></td>
			...
			<center>
				...
				<ul class="pager">
					<li><a href="${pb.url1}&pageNow1=1">首页</a></li>

					<c:if test="${pb.pageNow1>1 }">
					&nbsp;&nbsp;&nbsp;&nbsp;
					<li><a href="${pb.url1}&pageNow1=${pb.pageNow1-1 }">上一页(Previous)</a></li>
					...
					<c:forEach begin="${begin}" end="${end }" var="i">
						...
						<c:choose>
							...
							<c:otherwise>
								<li><a href="${pb.url1}&pageNow1=${i }">[${i}]</a></li>
							</c:otherwise>
					...
					<c:if test="${pb.pageNow1<pb.pages1 }">
						<li><a href="${pb.url1}&pageNow1=${pb.pageNow1+1 }">下一页(Next)</a></li>
					</c:if>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

					<li><a href="${pb.url1}&pageNow1=${pb.pages1 }">尾页</a></li>
				</ul>
